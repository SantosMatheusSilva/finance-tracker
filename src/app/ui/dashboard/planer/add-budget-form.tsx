...
export default function AddBudgetForm() {
    async function createBudget(formData: FormData) {
        ...
        const budget = await createBudgetService({
            user_id: userId,
            expense_category: formData.get("Expense Category") as "health" | "food" | "education" | "housing" | "transport" | "entertaiment" | "utilities" | "other",
    ...
    return (
        <Form action={createBudget}>
            <Select label="Expense Category" placeholder="Select a category for your budget">
            ...
            <Input label="Budget Amount" placeholder="Enter the amount for your budget" />
            <Input label="Period Start" placeholder="Enter the start date for your budget" />
            <Input label="Period End" placeholder="Enter the end date for your budget" />
